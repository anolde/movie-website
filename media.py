...
class Video():
    ...
    It contains the properties shared by all media types that can be shared on the site.
    """
    ...
    def show_trailer(self):
        """This function will open the trailer for the instance of the video using webbrowser"""
        webbrowser.open(self.trailer_youtube_url)
        
class Movie(Video):
    """ This class provides a way to store movie related information. 
    Takes in the Video parent class. 
    Movie attributes:
